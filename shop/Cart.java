    ...
    public void cartDisplay() {
        ...
        for (int i = 0; i < products.length; i++) {
            ...
            if (products[i] instanceof Digital) {
                System.out.println("Digital Product Name:" + products[i].getName() + " Brand:" + products[i].getBrand() + " Price:" + products[i].getPrice()+" BarCode: "+products[i].getBarCode());
            ...
            if (products[i] instanceof Shoe) {
                System.out.println("Shoe    Product Name:" + products[i].getName() + " Brand:" + products[i].getBrand() + " Price:" + products[i].getPrice()+" BarCode: "+products[i].getBarCode());
                totalPrice += products[i].getPrice();
                totalQuantity++;
